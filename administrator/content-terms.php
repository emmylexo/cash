<?php 
  ...
  if(isset($_POST['area'])) {
    ...
    $genInfo->redirect(BASE_URL.'administrator/content-terms?updated');
    exit();
  }
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="<?php echo BASE_URL;?>administrator/content-terms">Content Manager</a></li>
				...
				<div class="col-sm-12">
                    <div class="card-box">
                        <form method="post" action="" method="post">
                            ...
                            <input type="text" name="title" parsley-trigger="change" required class="form-control" id="title" value="<?php if(isset($siteInfo['terms_title'])){echo $siteInfo['terms_title'];}?>">
                                <br>
                            <textarea id="elm1" name="area"><?php if(isset($siteInfo['terms'])){echo $siteInfo['terms'];}?></textarea>
                            <br><br><br>
