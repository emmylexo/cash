...
<div id="custom-modal" class="modal-demo">
  ...
  <h4 class="custom-modal-title">Add New Donate Request</h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="form-group">
              <label for="phAmt">Donate Amount (in <?php echo $defaultCurrency['c_symbol'].' - '.$defaultCurrency['c_code'];?>) </label>
          ...
          <div class="col-lg-12">
            <p style="font-size:12px; font-style: italic;color: red;">1. Please do not Donate if you do not have the funds that you are pledging.<br>
