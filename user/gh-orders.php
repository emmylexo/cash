...
<?php if(!empty($orders)){?>
  ...
  <?php $i =0;
        foreach ($orders as $gh) {
          $i++;
          $payerInfo = $front->userInfo($gh['payer_id']);?>
      <tr>  
        <td><?php echo $i;?></td>
        ...
        <td><a class="btn btn-default btn-sm" href="<?php echo BASE_URL.'user/approve?ordid='.$gh['ord_id'] ?>">View Details</a> </td>
      </tr>
      <?php }?>      
    </tbody>
  </table>
