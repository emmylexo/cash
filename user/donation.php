...
<?php
  ...
  <div class="card-box m-t-20">
    <h4 class="m-t-0 header-title"><b>Enter your Donation Amount</b></h4>
    <div class="p-20">
...
<!--                                <li>20% Instant Merging</li>-->
      ...
      <form action="" method="post">
        <div class="form-group">
          <input class="form-control" type="number" name="phAmt" placeholder="Donate" required min="5000" max="1000000" value="5000">
        </div>
