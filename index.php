	        ...
	        <div class="row">
	            <div class="col-sm-6 col-md-6 col-lg-2">
	                <div class="price_card text-center">
	                    ...
	                    <ul class="price-features">
	                        ...
	                        <li>100% Instant Merging</li>
	                        <li>100% Automated</li>
	                        <li>24x7 Support</li>
	                    </ul>
	                    <form action="user/register" method="post">
	                      <input type="hidden" name="orderNow">
	                      <button type="submit" name="Cash360-Bicycle" class="btn btn-primary w-md waves-effect waves-light">Order Now</button>
	                    </form>
	            ...
	            <div class="col-sm-6 col-md-6 col-lg-2">
	                <div class="price_card text-center">
	                    ...
	                    <form action="user/register" method="post">
	                      <input type="hidden" name="orderNow">
	                      <button type="submit" name="Cash360-Car" class="btn btn-pink w-md waves-effect waves-light">Order Now</button>
	                    </form>
	                </div>
	            </div> <!-- end col -->
	            ...
	            <div class="col-sm-6 col-md-6 col-lg-3">
	                <div class="price_card text-center">
	                    ...
	                    <form action="user/register" method="post">
	                    <input type="hidden" name="orderNow">
	                      <button type="submit" name="Cash360-Plane" class="btn btn-purple w-md waves-effect waves-light">Order Now</button>
	                    </form>
	                </div> <!-- end Pricing_card -->
	            </div> <!-- end col -->
	            ...
	            <div class="col-sm-6 col-md-6 col-lg-3">
	                <div class="price_card text-center">
	                    ...
	                    <form action="user/register" method="post">
	                      <input type="hidden" name="orderNow">
	                      <button type="submit" name="Cash360-Jet" class="btn btn-success w-md waves-effect waves-light">Order Now</button>
	                    </form>
	                </div> <!-- end Pricing_card -->
	            </div> <!-- end col -->
