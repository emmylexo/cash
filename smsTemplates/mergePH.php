...
if(isset($configInfo['sms_note']) 
    ...
    $newPhone = $newPhone = str_replace('+', '', $phInfo['phone']);
    ...
    class SenderPH {
        ...
        //Constructor.. 
        public function SenderPH($host, $port, $username, $password, $sender, $message, $mobile, $msgtype, $dlr) {
            global $phoneCode;
            global $newPhone;
            global $SMSsender;
            global $SMSport;
    ...
    $obj = new SenderPH("IP/DOMAIN","PORT","USERNAME","PASSWORD","SENDER/SOURCE","MESSAGE","DESTINATION","MESSAGE TYPE","1");
    $obj->Submit ();
